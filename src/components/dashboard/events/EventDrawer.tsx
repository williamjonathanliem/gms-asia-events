            ...
            <div className="space-y-5 px-6 py-6">
              ...
              {!isNew && (
                <Link
                  ...
                  className="group flex w-full items-center gap-3 rounded-btn border border-[#E5E5E5] bg-[#fafafa] px-4 py-3 transition-colors hover:border-[#111111] hover:bg-white"
                >
                  <div className="flex size-8 shrink-0 items-center justify-center rounded border border-[#E5E5E5] bg-white transition-colors group-hover:border-[#111111]">
                    <svg className="size-4 text-[#111111]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                      <path strokeLinecap="round" strokeLinejoin="round" d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L10.582 16.07a4.5 4.5 0 01-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 011.13-1.897l8.932-8.931zm0 0L19.5 7.125" />
                    </svg>
                  </div>
                  <div className="min-w-0 flex-1">
                    <p className="text-sm font-semibold text-[#111111]">Edit Registration Form</p>
                    <p className="text-xs text-muted">Fields &middot; Theme &middot; Pop-up</p>
                  </div>
                  <svg className="size-4 shrink-0 text-muted transition-colors group-hover:text-[#111111]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
